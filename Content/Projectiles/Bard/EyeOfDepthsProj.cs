...
namespace HWJBardHealer.Content.Projectiles.Bard
{
    public class EyeOfDepthsProj : BardProjectile
    {
        ...
        {
            Projectile.width = 40;  // base hitbox
        ...
        public override void AI()
        {
            ...
            // Expand & accelerate slightly
            Projectile.velocity *= 1.04f;
            Projectile.scale *= 1.04f;

            // ? Move first, then resize hitbox
            Projectile.position += Projectile.velocity;

            // Re-center hitbox on new position
            ...
            // ? Add light
            Lighting.AddLight(Projectile.Center, 0.1f, 0.3f, 0.6f); // soft deep blue light
        }

        public override void BardOnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            // Apply debuff for deep-sea theme
            target.AddBuff(BuffID.Darkness, 180);

            // Reduce damage after each hit
            ...
            for (int i = 0; i < numProjectiles; i++)
            {
                ...
                Projectile.NewProjectile(
                    ...
                    target.Center,
                    velocity,
                    ProjectileID.WaterStream, // Replace later with your own bubble projectile
                    (int)(damageDone * 0.5f),
                    0f,
                    Projectile.owner
                );
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color edgeColor = new Color(10, 20, 60, 0) * fade;    // dark navy
            Color centerColor = new Color(0, 150, 255, 0) * fade; // glowing blue
